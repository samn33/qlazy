...
class QStateLogical(QState):
    ...
    def set_register(self, dat_left, dat_rignt, bnd, anc):
        ...
        self.__x_stab = {'left': [PauliProduct(pauli_str='XXX', qid=[dat_left[0], dat_left[2], dat_left[3]]),
                                  PauliProduct(pauli_str='XXXX', qid=[dat_left[1], dat_left[2], bnd[0], dat_left[4]])],
                         'right': [PauliProduct(pauli_str='XXXX', qid=[dat_right[0], bnd[0], dat_right[2], dat_right[3]]),
    ...
    def initialize(self, alpha=0.0, beta=0.0, gamma=0.0):
        ...
        self.cx(self.__dat['left'][0], self.__dat['right'][0])
        self.cx(self.__dat['left'][0], self.__dat['right'][1])
