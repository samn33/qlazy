...
class TestBackend_1_qubit_ibmq_qasm_simulator(unittest.TestCase):
    """ test 'Backend' : 1-qubit gate (ibmq_qasm_simulator)
    """
...
class TestBackend_2_qubit_ibmq_qasm_simulator(unittest.TestCase):
...
class TestBackend_3_qubit_ibmq_qasm_simulator(unittest.TestCase):
...
class TestBackend_operate_ibmq_qasm_simulator(unittest.TestCase):
...
class TestBackend_measure_qasm_simulator(unittest.TestCase):
...
class TestBackend_reset_ibmq_qasm_simulator(unittest.TestCase):
...
class TestBackend_inheritance_ibmq_qasm_simulator(unittest.TestCase):
    """ test 'Backend' : inheritance (ibmq_qasm_simulator)
    """
