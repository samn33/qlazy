...
class TestBackend_2_qubit_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_3_qubit_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_operate_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_measure_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_reset_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_expect_qulacs_cpu_simulator(unittest.TestCase):
...
class TestBackend_inheritance_qulacs_cpu_simulator(unittest.TestCase):
